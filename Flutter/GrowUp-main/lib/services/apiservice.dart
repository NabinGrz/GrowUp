...
import 'package:growup/models/loginmodel.dart';
...
import 'package:growup/models/registermodel.dart';
...
final baseUrlGet =
    "https://683c-2400-1a00-b020-de2a-914a-ddd4-a455-9426.ngrok.io";
final baseUrlPost = "683c-2400-1a00-b020-de2a-914a-ddd4-a455-9426.ngrok.io";
late var myUrlTutor;
...
late var response;
//late List data;
List<NewsFeedModells>? newsFeed;
Map? map;
//var _data;

Future getNewsFeed() async {
  final String response = await rootBundle.loadString('json/users.json');
  var newsFeed = await Future.delayed(
      const Duration(seconds: 1), () => newsFeedModelFromJsonlls(response));
...
Future bookTutor(
  ...
  if (responseBooking.statusCode == 200) {
    var bookingResponse = await responseBooking.body;
...
Future getSkillDetails() async {
  print("FINAL TOKEN OF USER:" + await obtainedtokenData.toString());
  myUrl = Uri.parse(
    // "$baseUrlGet/api/v1/getskills",
    "https://683c-2400-1a00-b020-de2a-914a-ddd4-a455-9426.ngrok.io/api/v1/getskills",
  );
...
Future postNewsFeed(String title, File file) async {
  var request = await http.MultipartRequest(
      "POST",
      Uri.parse(
          "https://683c-2400-1a00-b020-de2a-914a-ddd4-a455-9426.ngrok.io/api/v1/addnewsfeed"));
